...
* **João Los** - Implementação da lógica de grafos e desenvolvimento da solução em Java.
* **Gustavo Kloster Jorge** - Estruturação do repositório, elaboração da documentação, análise de complexidade e testes de validação dos requisitos do sistema.
